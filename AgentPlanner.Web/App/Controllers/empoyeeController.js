...
app.controller('employeeController', ['employeeService', 'notificationService', 'FileUploader', '$scope', '$sessionStorage', 'NgTableParams', '$q', '$state','$stateParams','blockUI',"$timeout",
    function (employeeService, notificationService, fileUploader, $scope, $sessionStorage, ngTableParams, $q, $state, $stateParams, blockUI, $timeout) {
        var scope = this;
