...
app.controller('siteController', ['siteService', 'notificationService', 'NgTableParams', '$q', 'clientService', '$state', '$stateParams',
    function (siteService, notificationService, ngTableParams, $q, clientService, $state, $stateParams) {
        var scope = this;
